...
namespace HFramework
{
    internal class ObjectPoolManager : HModule, IObjectPoolManager
    {
        ...
        private ObjectPoolEntity _poolCollectionEntity;
        ...
        public void PushObj(string path, GameObject obj)
        {
            ...
            {
                if (_poolCollectionEntity == null)
                {
                    _poolCollectionEntity = new GameObject("Pool").AddComponent<ObjectPoolEntity>();
                }

                _objectPoolCollection.Add(path, new ObjectPool(path, _poolCollectionEntity.gameObject, obj));
            }
        }
        ...
        public void Clear()
        {
            ...
            Object.Destroy(_poolCollectionEntity);
            _poolCollectionEntity = null;
        }
    }
}